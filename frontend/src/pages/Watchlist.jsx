            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {watchlistData.length > 0 ? (
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 p-16 text-center">
                        ...
                        <h3 className="text-xl font-bold text-slate-900 mb-3">Your watchlist is empty</h3>
                ...
                {/* Search Modal */}
                {showSearch && (
                    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-start justify-center pt-32 z-50 p-4">
                            ...
                            <div className="max-h-80 overflow-y-auto">
                                {searchTerm && filteredStocks.length > 0 ? (
                                    ...
                                    <div className="text-center py-12 px-6">
                                        ...
                                        <p className="text-sm text-slate-500">No stocks found for "{searchTerm}"</p>
                                    </div>
                                ) : (
                                    <div className="text-center py-12 px-6">
                                        <p className="text-sm text-slate-400">Type to search for stocks</p>
                                    </div>
                                )}
                            </div>
                        </div>
