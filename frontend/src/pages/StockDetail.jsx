  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6 lg:space-y-8">
        ...
        >
          <div className="p-2.5 sm:p-2 bg-white border border-slate-200 rounded-lg hover:border-slate-300 transition-colors">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-6">
            <div className="space-y-1 sm:space-y-2">
              <div className="flex items-center gap-2 sm:gap-3">
                <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight">{symbol}</h1>
                <span className="px-2 sm:px-3 py-1 bg-slate-100 text-slate-500 text-[10px] sm:text-xs font-semibold uppercase tracking-wider rounded-md">
                  NEPSE
                </span>
              </div>
              <p className="text-xs sm:text-sm text-slate-500">{details?.securityName}</p>
            </div>
            
            <div className="flex flex-col items-start md:items-end gap-1 sm:gap-2">
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 tracking-tight tabular-nums">
                {formatCurrency(details?.lastTradedPrice || 0)}
              </p>
              <div className={`inline-flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg text-xs sm:text-sm font-semibold ${isPositive ? 'bg-emerald-50 text-emerald-700' : 'bg-red-50 text-red-700'}`}>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200 shadow-sm">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <span className="text-[10px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider">Open Price</span>
            </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200 shadow-sm">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <span className="text-[10px] sm:text-xs font-semibold text-emerald-600 uppercase tracking-wider">Day High</span>
            </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200 shadow-sm">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <span className="text-[10px] sm:text-xs font-semibold text-red-600 uppercase tracking-wider">Day Low</span>
            </div>
          ...
          <div className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-slate-200 shadow-sm">
            <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              ...
              <span className="text-[10px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider">Volume</span>
            </div>
            <p className="text-xl sm:text-2xl font-bold text-slate-900 tabular-nums">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-9 bg-slate-900 rounded-xl sm:rounded-2xl border border-slate-800 p-3 sm:p-4 shadow-lg">
              ...
              {history.length > 0 ? (
                ...
                <div className="h-full flex flex-col items-center justify-center gap-4">
                  <div className="p-3 sm:p-4 bg-slate-800 rounded-xl">
                    <Activity className="h-6 w-6 sm:h-8 sm:w-8 text-slate-600" />
                  </div>
                  <p className="text-xs sm:text-sm text-slate-500">Historical data unavailable</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-3 bg-white rounded-xl sm:rounded-2xl border border-slate-200 shadow-sm flex flex-col h-[300px] sm:h-[350px] lg:h-auto lg:max-h-[400px]">
            <div className="p-4 sm:p-5 border-b border-slate-100 flex items-center justify-between shrink-0">
              <h3 className="text-xs sm:text-sm font-bold text-slate-900">Sector Indices</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          {/* Trading Metrics */}
          <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200 p-5 sm:p-8 shadow-sm">
            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-4 sm:mb-6">Trading Metrics</h3>
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between py-2 sm:py-3 border-b border-slate-100">
                <span className="text-xs sm:text-sm text-slate-500">Previous Close</span>
                <span className="font-semibold text-slate-900 tabular-nums text-sm sm:text-base">
                  {formatCurrency(details?.previousClose || 0)}
                </span>
              </div>
              <div className="flex items-center justify-between py-2 sm:py-3 border-b border-slate-100">
                <span className="text-xs sm:text-sm text-slate-500">52 Week High</span>
                <span className="font-semibold text-emerald-700 tabular-nums text-sm sm:text-base">
                  {formatCurrency(details?.fiftyTwoWeekHigh || 0)}
                </span>
              </div>
              <div className="flex items-center justify-between py-2 sm:py-3 border-b border-slate-100">
                <span className="text-xs sm:text-sm text-slate-500">52 Week Low</span>
                <span className="font-semibold text-red-700 tabular-nums text-sm sm:text-base">
                  {formatCurrency(details?.fiftyTwoWeekLow || 0)}
                </span>
              </div>
              <div className="flex items-center justify-between py-2 sm:py-3">
                <span className="text-xs sm:text-sm text-slate-500">Average Traded</span>
                <span className="font-semibold text-slate-900 tabular-nums text-sm sm:text-base">
          ...
          {/* Market Metadata */}
          <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200 p-5 sm:p-8 shadow-sm">
            <h3 className="text-base sm:text-lg font-bold text-slate-900 mb-4 sm:mb-6">Market Metadata</h3>
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between py-2 sm:py-3 border-b border-slate-100">
                <span className="text-xs sm:text-sm text-slate-500">Market Cap</span>
                <span className="font-semibold text-slate-900 tabular-nums text-sm sm:text-base">
                  {formatVolume(details?.marketCapitalization || 0)}
                </span>
              </div>
              <div className="flex items-center justify-between py-2 sm:py-3 border-b border-slate-100">
                <span className="text-xs sm:text-sm text-slate-500">Listed Shares</span>
                <span className="font-semibold text-slate-900 tabular-nums text-sm sm:text-base">
                  {formatVolume(details?.outstandingShares || 0)}
                </span>
              </div>
              <div className="flex items-center justify-between py-2 sm:py-3 border-b border-slate-100">
                <span className="text-xs sm:text-sm text-slate-500">Sector</span>
                <span className="font-semibold text-slate-900 text-sm sm:text-base">
                  {details?.sectorName || '—'}
                </span>
              </div>
              <div className="flex items-center justify-between py-2 sm:py-3">
                <span className="text-xs sm:text-sm text-slate-500">Last Updated</span>
